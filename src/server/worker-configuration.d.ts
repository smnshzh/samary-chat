/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-configuration.d.ts` (hash: ca85a63ff8d697aab2b6bed00b96afc1)
...
declare namespace Cloudflare {
	interface Env {
		...
		Auth: DurableObjectNamespace<import("./index").Auth>;
		ASSETS: Fetcher;
	}
}
